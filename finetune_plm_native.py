...
if __name__ == '__main__':
    p = argparse.ArgumentParser(description="Finetune PLM model with configuration file")
    p.add_argument('--config_path', required=True, help="Path to the configuration file to load")
